          ...
          <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTabLeave"  @tab-click="tabClicked">
            <el-tab-pane label="基本信息" name="0">
              ...
              <el-form-item label="商品分类" prop="goods_cat">
                <el-cascader :options="catelist" :props="cateProps" v-model="addForm.goods_cat" @change="handleChange" clearable></el-cascader>
              </el-form-item>
            </el-tab-pane>
            ...
            <el-tab-pane label="商品图片" name="3">
              ...
              <el-upload :action="uploadURL" :on-preview="handlePreview"
                         ...
                         :headers="heagerPbj" :on-success="handleSuccess">
